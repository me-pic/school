 ...
 * the [python data analysis](/modules/python_data_analysis) or the [python scripts](/modules/python_scripts) module.
...
Calculate the total energy and carbon emissions for the jobs listed in the Slurm log files using the formula given below. You may write a python script from scratch or complete the jupyter notebook provided in the Github repository. The definition of the variables needed is provided in the glossary below. Do not forget to pay attention to the units of each variable.
